...
class Params():
    """Class that loads hyperparameters from a jason file.
...
def set_logger(log_path):
    ...
    In general, it is useful to have logger so that every output to the terminal is saved
...
def load_checkpoint(checkpoint, model, optimizer=None):
    """Loads model parameters (state_dict) from checkpoint. If optimizer is provided, loads state_dict of

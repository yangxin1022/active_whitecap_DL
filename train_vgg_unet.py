...
def train_and_evaluate(model, train_dataloader, val_dataloader, optimizer,
    ...
    writer = SummaryWriter(log_dir="./model/test", flush_secs=120)
...
if __name__ == '__main__':
    ...
    model_dir = 'E:/my-whitecaps/code/organized/model/test'
    # Log dir
    log_dir = 'E:/my-whitecaps/code/organized/log'
    log_name = 'train_vgg_unet.log'
    ...
    model = u_net.Unet(params,pretrained=False,backbone='vgg').float().cuda() if params.cuda else u_net.UNet(params).float()
    ...
    train_and_evaluate(model, train_dl, val_dl, optimizer, loss_fn,
                       metrics, params, model_dir, restore_file)
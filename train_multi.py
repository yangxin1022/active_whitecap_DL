...
# Load local files
import model.u_net_plus as u_net
...
if __name__ == '__main__':
    ...
    #train_features_dir = 'E:/my-whitecaps/data/segmentation_v1/train/images/data'
    #train_labels_dir = 'E:/my-whitecaps/data/segmentation_v1/train/masks/data'
    #valid_features_dir = 'E:/my-whitecaps/data/segmentation_v1/valid/images/data'
    #valid_labels_dir = 'E:/my-whitecaps/data/segmentation_v1/valid/masks/data'
    ...
    #model_dir = 'E:/my-whitecaps/code/organized/model/test/vgg_test2'
    #param_dir = 'E:/my-whitecaps/code/organized/model'
    model_dir = 'C:/Users/yang.xin1022/Desktop/train_test2/vgg_test'
    param_dir = 'E:/my-whitecaps/code/organized/model'
    
    # Log dir
    log_dir = 'E:/my-whitecaps/code/organized/log'
    log_name = 'train_vgg_unet_totoal_W.log'
    tensorboard_dir = './model/test/vgg_test_total_W'
    ...
    model = u_net.Unet(params,pretrained=False,backbone='resnet50').float().cuda() if params.cuda else u_net.UNet(params).float()
